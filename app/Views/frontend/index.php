...
<head>
	...
	<link rel="stylesheet" href="./assets/frontend/css/vendor.css">
	<link rel="stylesheet" href="./assets/frontend/css/main.css">
	<link rel="stylesheet" href="./assets/frontend/css/slideshow.css">
	...
	<!-- favicons
    ================================================== -->
	<link rel="shortcut icon" href="./assets/images/logo/63-512.png" type="image/x-icon">
	<link rel="icon" href="./assets/images/logo/63-512.png" type="image/x-icon">
...
<!-- home
================================================== -->
<section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="./assets/frontend/images/sigaka/background.png" data-natural-width=3000 data-natural-height=2000 data-position-y=top>
	...
	<div class="home-content">
		...
		<div class="row home-content__main">
			...
			<p>
				Memberikan media terbaik bagi anda untuk menyampaikan gagasan ke seluruh penjuru dunia
			</p>
		...
		<div class="col-full">
			...
			<div class="slideshow-container">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/alyssa.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/aurel.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/dana.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/inara.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/namira.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/selkom.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/sk.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/syafian.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/syafitra.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="./assets/frontend/images/sigaka/syahdan.jpeg" style="width: 100%; height: 650px; margin: 0 auto">
			...
			<div class="masonry__brick" data-aos="fade-up">
				<div class="item-folio">
					...
					<div class="item-folio__thumb">
						<a href="./assets/frontend/images/sigaka/alyssa.jpeg" class="thumb-link" title="Alyssa" data-size="1050x700">
							<img src="./assets/frontend/images/sigaka/alyssa.jpeg"
								 srcset="./assets/frontend/images/sigaka/alyssa.jpeg 1x, ./assets/frontend/images/sigaka/alyssa.jpeg 2x" alt="">
						</a>
					</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="http://wikidevia.Duta Sarana Informatika.id/" target="_blank">Duta Sarana Informatika</a>
