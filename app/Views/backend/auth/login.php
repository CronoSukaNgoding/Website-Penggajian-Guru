						...
						<div class="card border-grey border-lighten-3 px-1 py-1 m-0">
							<div class="card-header border-0">
								<!-- <div class="text-center mb-1">
									<img src="/assets/images/logo/images.png" alt="branding logo">
								</div> -->
								<div class="font-large-1  text-center">
									Login
								</div>
								<?php if(session()->getFlashData("sukses")): ?>
									<div class="toast-body bg-success position-fixed top-0 end-0 p-3 text-light"
										id="toast" style="z-index:9999;">
										<strong> <?=session()->getFlashData("sukses")?> </strong>
									</div>

									<?php elseif  (session()->getFlashData("gagal")): ?>
									<div class="toast-body bg-danger position-fixed top-0 end-0 p-3 text-light"
										id="toast" style="z-index:9999;">
...
<!-- BEGIN: Page JS-->
<script src="/assets/js/scripts/forms/form-login-register.min.js" type="text/javascript"></script>
<!-- END: Page JS-->
