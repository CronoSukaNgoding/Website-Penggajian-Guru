            ...
            <div class="card-body">
                ...
                <form action="<?=base_url("/profil/updateprofil/". $user->user_id)?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group floating-label-form-group">
                        ...
                        <input type="number" class="form-control" name="nuptk" id="tempat" value="<?= $result->nuptk;?>" placeholder=" NUPTK"
                            autocomplete="off" required>
                    </div>
                    <div class="form-group floating-label-form-group">
                        <label for="tempat">Tempat Lahir</label>
                        <input type="text" class="form-control" name="tempat_lahir" id="tempat" value="<?= $result->tempat_lahir;?>"
                            placeholder="Tempat Lahir" autocomplete="off" required>
                    </div>
                    <div class="form-group floating-label-form-group">
                        <label for="tl">Tanggal Lahir</label>
                        <div class='input-group'>
                            <input type="date" class="form-control" name="tgl_lahir" id="tl" value="<?= $result->tgl_lahir;?>"
